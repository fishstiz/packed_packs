...
public class PackIconManager {
    ...
    public static final ResourceLocation DEFAULT_FOLDER_ICON = PackedPacks.id("textures/misc/unknown_folder.png");
    ...
    public ResourceLocation get(Pack pack) {
        if (!cachedIcons.containsKey(pack.getId())) {
            ResourceLocation fallback = (this.staleIcons != null) ? this.staleIcons.get(pack.getId()) : null;
            if (fallback == null) {
    ...
    public static ResourceLocation getDefault(Pack pack) {
