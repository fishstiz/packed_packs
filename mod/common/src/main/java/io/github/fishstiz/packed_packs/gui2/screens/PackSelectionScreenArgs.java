package io.github.fishstiz.packed_packs.gui2.screens;
...
public record PackSelectionScreenArgs(
    ...
    public static PackSelectionScreenArgs dummy(Minecraft minecraft) {
        return new PackSelectionScreenArgs(
                new PackRepository(),
    ...
    public PackSelectionScreen createScreen(@Nullable Screen previous) {
