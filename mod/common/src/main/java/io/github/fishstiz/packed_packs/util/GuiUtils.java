...
public final class GuiUtils {
    ...
    public static final Identifier ARROW_UP_SPRITE = PackedPacks.id("icon/arrow_up");
    public static final Identifier CROSS_SPRITE = PackedPacks.id("icon/cross");
    public static final Identifier LOCK_SPRITE = Identifier.withDefaultNamespace("widget/locked_button");
    public static final Identifier LOCK_SPRITE_DISABLED = Identifier.withDefaultNamespace("widget/locked_button_disabled");
    public static final Identifier LOCK_SPRITE_HIGHLIGHTED = Identifier.withDefaultNamespace("widget/locked_button_highlighted");
    public static final Identifier UNLOCK_SPRITE = Identifier.withDefaultNamespace("widget/unlocked_button");
    public static final Identifier UNLOCK_SPRITE_HIGHLIGHTED = Identifier.withDefaultNamespace("widget/unlocked_button_highlighted");
    public static final Identifier UNLOCK_SPRITE_SMALL = PackedPacks.id("icon/unlock");
    public static final Identifier LOCK_SPRITE_SMALL = PackedPacks.id("icon/lock");
    public static final Identifier STAR_SPRITE = PackedPacks.id("icon/star");
    public static final Identifier TRASH_SPRITE = PackedPacks.id("icon/trash");
    public static final Identifier RADIO_OFF_SPRITE = PackedPacks.id("icon/radio_off");
    public static final Identifier RADIO_ON_SPRITE = PackedPacks.id("icon/radio_on");
    ...
    public static Identifier toggleIcon(boolean toggled) {
    ...
    public static WidgetElements padded16Sprite(Identifier sprite) {
    ...
    public static void renderDropToDisabledZone(AbstractWidget widget, GuiGraphicsExtractor graphics) {
        int x = widget.getX();
        int y = widget.getY();
