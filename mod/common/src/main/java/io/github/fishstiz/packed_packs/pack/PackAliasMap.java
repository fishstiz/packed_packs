...
public class PackAliasMap implements Map<String, Pack> {
    ...
    @Override
    public Pack computeIfAbsent(String key, @NonNull Function<? super String, ? extends Pack> mappingFunction) {
        return this.map.computeIfAbsent(key, mappingFunction);
    }

    @Override
    public Pack computeIfPresent(String key, @NonNull BiFunction<? super String, ? super Pack, ? extends Pack> remappingFunction) {
        return this.map.computeIfPresent(key, remappingFunction);
    }

    @Override
    public Pack compute(String key, @NonNull BiFunction<? super String, ? super Pack, ? extends Pack> remappingFunction) {
        return this.map.compute(key, remappingFunction);
    }

    @Override
    public Pack merge(String key, @NonNull Pack value, @NonNull BiFunction<? super Pack, ? super Pack, ? extends Pack> remappingFunction) {
