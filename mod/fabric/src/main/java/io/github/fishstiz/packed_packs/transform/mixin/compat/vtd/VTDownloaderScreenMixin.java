...
@Mixin(value = VTDownloadScreen.class, remap = false)
public abstract class VTDownloaderScreenMixin extends Screen {
    ...
    @WrapOperation(method = "readResourcePack", at = @At(
            value = "INVOKE",
            target = "Lme/bymartrixx/vtd/access/EntryBaseAccess;vtdownloader$getPack()Lnet/minecraft/server/packs/repository/Pack;",
            remap = true
    ))
