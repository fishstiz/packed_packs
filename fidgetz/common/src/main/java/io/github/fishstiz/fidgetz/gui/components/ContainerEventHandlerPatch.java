...
public interface ContainerEventHandlerPatch extends ContainerEventHandler {
    ...
    @Override
    default boolean mouseReleased(@NotNull MouseButtonEvent mouseButtonEvent) {
        return ContainerEventHandler.super.mouseReleased(mouseButtonEvent);
    }

    @Override
    default boolean mouseDragged(@NotNull MouseButtonEvent mouseButtonEvent, double dragX, double dragY) {
